...
# Could get redshift from data, since we dont have all the data uploaded here, these are the available
...
# Load data. The "split" here is to fetch each "P(k)/P(k)_GR" block individually
...
# One plot for each version of the emulator (we only have one here):

...
# Call the emulators
lin_emulator     = PofkBoostEmulator(path = lin_emulator_folder, version = lin_emulator_version)
lin_boost        = lin_emulator(params_batch)

nl_noscreening_emulator = PofkBoostEmulator(path = nl_noscreening_emulator_folder, version = nl_noscreening_emulator_version)
nl_noscreening_boost    = nl_noscreening_emulator(params_batch)

nl_screening_emulator = PofkBoostEmulator(path = nl_screening_emulator_folder, version = nl_screening_emulator_version)
nl_screening_boost    = nl_screening_emulator(params_batch)
